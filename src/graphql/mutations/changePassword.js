...
module.exports = async (UserModel , passwords, user) => {
    ...
    try {
        ...
        // Input validation
        if(oldPassword.trim() === '') errors.oldPassword = 'Old Password cannot be empty!';
        if(newPassword.trim() === '') errors.newPassword = 'New Password cannot be empty!';
        ...
        if(newPassword !== confirmPassword) errors.confirmPassword = 'Passwords does not match!';
